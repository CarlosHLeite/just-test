                ...
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card border border-light-subtle rounded-3 card-shadow">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <h2 class="fs-6 fw-normal text-center text-secondary mb-4">Bem vindo(a) de volta!</h2>
                            ...
                            <form action="/login" method="POST">
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="/forgot-password" class="link-success text-decoration-none">Esqueci minha senha</a>
                                    </div>
                                </div>
                                <div class="col-12">
